...
(Nevers et al., 2022). The research will predominantly use Python programming language in conjunction with Jupyter Notebook for data analysis, processing, and visualization.
